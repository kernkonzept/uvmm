...
Guest::subarch_init()
{
  ...
  if (has_aarch32())
    {
      ...
      add_sys_reg_aarch64(3, 0, 0, 1, 2, cxx::make_ref_obj<Sys_reg_feat>([](){
        ...
        return regval & (  (  0UL << 28)    // Mask TraceFilt
                         | (  0UL << 24)    // Mask PerfMon
      ...
      add_sys_reg_aarch64(3, 0, 0, 1, 4, cxx::make_ref_obj<Sys_reg_feat>([](){
        ...
        return regval & (  (0xfUL << 28)    // InnerShr
                         | (0xfUL << 24)    // FCSE
                         | (0xfUL << 20)    // AuxReg
                         | (0xfUL << 16)    // TCM
                         | (0xfUL << 12)    // ShareLvl
      ...
      add_sys_reg_aarch64(3, 0, 0, 1, 6, cxx::make_ref_obj<Sys_reg_feat>([](){
        ...
        return regval & (  (0xfUL << 28)    // HWAccFlg
                         | (0xfUL << 24)    // WFIStall
                         | (0xfUL << 20)    // MemBarr
                         | (0xfUL << 16)    // UniTLB
                         | (0xfUL << 12)    // HvdTLB
      ...
      add_sys_reg_aarch64(3, 0, 0, 1, 7, cxx::make_ref_obj<Sys_reg_feat>([](){
        ...
        return regval & (  (0xfUL << 28)    // Supersec
                         | (0xfUL << 24)    // CMemSz
                         | (0xfUL << 20)    // CohWalk
                         | (0xfUL << 16)    // PAN
                         | (0xfUL << 12)    // MaintBcst
      ...
      add_sys_reg_aarch64(3, 0, 0, 2, 1, cxx::make_ref_obj<Sys_reg_feat>([](){
        ...
        return regval & (  (0xfUL << 28)    // Jazelle
                         | (0xfUL << 24)    // Interwork
                         | (0xfUL << 20)    // Immediate
                         | (0xfUL << 16)    // IfThen
                         | (0xfUL << 12)    // Extend
      ...
      add_sys_reg_aarch64(3, 0, 0, 2, 2, cxx::make_ref_obj<Sys_reg_feat>([](){
        ...
        return regval & (  (0xfUL << 28)    // Reversal
                         | (0xfUL << 24)    // PSR_AR
                         | (0xfUL << 20)    // MultU
                         | (0xfUL << 16)    // MultS
                         | (0xfUL << 12)    // Mult
      ...
      add_sys_reg_aarch64(3, 0, 0, 2, 4, cxx::make_ref_obj<Sys_reg_feat>([](){
        ...
        return regval & (  (0xfUL << 28)    // SWP_frac
                         | (0xfUL << 24)    // PSR_M
      ...
      add_sys_reg_aarch64(3, 0, 0, 3, 0, cxx::make_ref_obj<Sys_reg_feat>([](){
        ...
        return regval & (  (0xfUL << 28)    // FPRound
                         | (0xfUL << 24)    // FPShVec
                         | (0xfUL << 20)    // FPSqrt
                         | (0xfUL << 16)    // FPDivide
                         | (0xfUL << 12)    // FPTrap
      ...
      add_sys_reg_aarch64(3, 0, 0, 3, 1, cxx::make_ref_obj<Sys_reg_feat>([](){
        ...
        return regval & (  (0xfUL << 28)    // SIMDFMAC
                         | (0xfUL << 24)    // FPHP
                         | (0xfUL << 20)    // SIMDHP
                         | (0xfUL << 16)    // SIMDSP
                         | (0xfUL << 12)    // SIMDInt
      ...
      add_sys_reg_aarch64(3, 0, 0, 3, 4, cxx::make_ref_obj<Sys_reg_feat>([](){
        ...
        return regval & (  (  0UL <<  8)    // Mask RAS_frac (RAS)
                         | (0xfUL <<  4)    // SSBS
                         | (0xfUL <<  0));  // CSV3
      }));
      ...
      add_sys_reg_aarch64(3, 0, 0, 3, 5, cxx::make_ref_obj<Sys_reg_feat>([](){
        ...
        return regval & (  (  0UL <<  4)    // Mask HPMN0 (PMU)
  ...
  add_sys_reg_aarch64(3, 0, 0, 4, 1, cxx::make_ref_obj<Sys_reg_feat>([](){
    ...
    return regval & (  (  0UL << 60)    // Mask PFAR
  ...
  add_sys_reg_aarch64(3, 0, 0, 4, 2, cxx::make_ref_obj<Sys_reg_feat>([](){
    ...
    return regval & (  (0xfUL <<  8)    // Mask MTEFAR (MTE)
  ...
  add_sys_reg_aarch64(3, 0, 0, 5, 0, cxx::make_ref_obj<Sys_reg_feat>([](){
    ...
    return regval & (  (  0UL << 60)    // Mask HPMN0
  ...
  add_sys_reg_aarch64(3, 0, 0, 5, 1, cxx::make_ref_obj<Sys_reg_feat>([](){
    ...
    return regval & (  (  0UL << 56)    // Mask ABL_CMPs
                     | (  0UL << 52)    // Mask DPFZS
                     | (  0UL << 48)    // Mask EBEP
                     | (  0UL << 44)    // Mask ITE
                     | (  0UL << 40)    // Mask ABLE
  ...
  add_sys_reg_aarch64(3, 0, 0, 7, 3, cxx::make_ref_obj<Sys_reg_feat>([](){
    ...
    return regval & (  (  0UL << 60)    // Mask Spec_FPACC (FEAT_PAuth++)
